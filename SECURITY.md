...
`mailkube-rails` follows [Semantic Versioning](https://semver.org/). Security
...
[**"Report a vulnerability"**](https://github.com/mailkube/mailkube-rails/security/advisories/new)
